  ...
  return (
    <div className='carrusel'>
      ...
      >
        ...
        <CarouselSlide><Activity titulo={"We made it to the nationals!"}preview={"Just qualified to Innobotica national contest!"} imgSrc={imgInnobotica} date="08/10/2024" link={"https://www.facebook.com/share/p/uMkiem5WP9vmKZ2z/"}></Activity></CarouselSlide>
